...
- 合成标签闭环**仅用于算法开发**；泛化性由两条独立链路检验（见下）。
...
|---|---|---|
| 窟内 RH 年均 | 32.8% | 30.8% |
| 日较差比 开门/闭窟 | 0.252 / 0.046 | 0.276 / 0.043 |
| 年极差比 T | 0.529 | 0.559 |
| 窟内年均温 | 比窟外 +1.9 K | +0.75 K（偏暖约 1.2 K） |
| 游客 RH 峰值抬升 | +0.17 pp | +11 pp（未复现，见技术路线 §7.2） |
